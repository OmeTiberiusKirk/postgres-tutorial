...
PostgreSQL เป็นระบบจัดการฐานข้อมูลเชิงสัมพันธ์ (RDBMS) ซึ่งหมายความว่า เป็นระบบที่
จัดการข้อมูลที่จัดเก็บในรูปแบบความสัมพันธ์
...
ตารางต่างๆ จะถูกจัดกลุ่มเป็นฐานข้อมูล และกลุ่มของฐานข้อมูลที่ จัดการโดยอินสแตนซ์เซิร์ฟเวอร์
PostgreSQL เดียว จะประกอบเป็นคลัสเตอร์ฐานข้อมูล
