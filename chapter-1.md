...
[^3]: `exat=#` นั่นหมายความว่า คุณเป็นผู้ใช้ระดับสูงสุดของฐานข้อมูล ซึ่งเป็นไปได้หากคุณติดตั้งอินสแตนซ์ PostgreSQL ด้วยตนเอง การเป็นผู้ใช้ระดับสูงสุด หมายความว่าคุณจะไม่ถูกจำกัดการเข้าถึง
